...
@CheckResult
fun <T : Fragment> T.startIntentRx(intent: Intent) : Observable<Result<T>>
        = RxActivityResult.on(this).startIntent(intent)

@CheckResult
fun <T : Fragment> T.startIntentRx(intent: Intent, onPreResult: OnPreResult<T>) : Observable<Result<T>>
        = RxActivityResult.on(this).startIntent(intent, onPreResult)

@CheckResult
fun <T : Fragment> T.startIntentSenderRx(intentSender: IntentSender,
